...
export default function FujianClassicRouteCompact({ props }: { props: LocalizedTripProps }) {
  ...
  return <main className={`trip-detail-page ${styles.themePage} ${styles.compactPage} ${styles.expV3Page}`} lang={props.locale === "zh-TW" ? "zh-Hant" : props.locale}>
    ...
    <section className={`${styles.compactHero} ${styles.akHero}`}><img src={img(2)} alt={alt(2)} aria-hidden="true" /><div className="shell"><p className={styles.akHeroLabel}>PRIVATE JOURNEY</p><h1>福建经典</h1><p className={styles.akHeroSub}>5 DAYS · PRIVATE FUJIAN JOURNEY</p><p className={styles.akHeroLine}>从海边到山谷，再走进闽南古城。</p><a className={styles.classicPrimary} href={plan}>开始定制这条路线 →</a></div></section>
    <section className={styles.akOverview}><div className="shell"><div className={styles.akOverviewIntro}><p className={styles.classicEyebrow}>THE JOURNEY</p><h2>第一次来福建，<br />这五天刚刚好。</h2><p>福建并不适合赶着玩。厦门适合慢慢开始，鼓浪屿值得留出完整的一天；离开海边往山里走，会看到福建完全不同的一面——土楼、村落和山谷里的生活。</p><p>到了泉州，福建的历史、闽南文化和当地人的日常又重新连在一起。这里有千年的古城，也有热闹的市井，还有让人念念不忘的地道美食。</p><p>这不是一条需要严格照着执行的路线。什么时候出发、在哪里多停留一天、住什么样的酒店，都可以根据你和家人的旅行方式重新安排。</p><div className={styles.akSignature}>SAME PLACE.<br />A DEEPER FUJIAN.</div></div><div className={styles.akOverviewMeta}><p>5 DAYS</p><span className={styles.akMetaLead}>A WELL-PACED<br />JOURNEY</span><ol className={styles.akRouteTimeline}><li><b>厦门</b><small>XIAMEN</small></li><li><b>鼓浪屿</b><small>GULANGYU</small></li><li><b>福建土楼</b><small>FUJIAN TULOU</small></li><li><b>泉州</b><small>QUANZHOU</small></li></ol><div className={styles.akMetaFacts}><span>PRIVATE JOURNEY<br /><em>私人旅行</em></span><span>FLEXIBLE<br /><em>行程可调整</em></span><span>2 – 8 PEOPLE<br /><em>建议 2 – 8 人</em></span><span>MORE THAN SIGHTS<br /><em>文化 · 美食 · 人文 · 自然</em></span></div></div></div></section>
